...
const Skills = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const skillRows = gsap.utils.toArray(".skills-section.portfolio-skills .skill-row");
      ...
      gsap.fromTo(".skills-section.portfolio-skills .skills-card::before",
        {
  ...
  const renderSkill = (skill) => (
    <li key={skill.name} className="skill-row" title={skill.name}>
      {skill.icon && (
        <img src={skill.icon} alt={`${skill.name} logo`} className="skill-icon" aria-hidden="true" />
      )}
